...
public class InformationPageActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tic_tac_toe2);
    ...
    public void onClick(View v) {
        ...
        Intent intent = new Intent(InformationPageActivity.this, InformationResultActivity.class); // pass information to the results activity
